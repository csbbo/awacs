"""
Django settings for awacs project.
...
SECRET_KEY = 'w2fhy8yh@=mw(mx&fm&ing*yal266j57^j2q5dz4@#d4n&^7%a'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://as_redis:6379/1",
        "OPTIONS": {
...
WSGI_APPLICATION = 'awacs.wsgi.application'
